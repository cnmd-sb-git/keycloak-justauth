...
public class AliyunIdentityProviderFactory extends
        AbstractIdentityProviderFactory<JustIdentityProvider< AuthAliyunRequest>>
        implements SocialIdentityProviderFactory<JustIdentityProvider< AuthAliyunRequest>> {
  ...
  @Override
  public JustIdentityProvider< AuthAliyunRequest> create(KeycloakSession session, IdentityProviderModel model) {
    return new JustIdentityProvider<>(session, new JustIdentityProviderConfig<>(model,JUST_AUTH_KEY, AuthAliyunRequest::new));
  }
