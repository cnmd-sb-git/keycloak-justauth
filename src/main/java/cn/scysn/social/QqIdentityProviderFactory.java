...
public class QqIdentityProviderFactory extends
        AbstractIdentityProviderFactory<JustIdentityProvider< AuthQqRequest>>
        implements SocialIdentityProviderFactory<JustIdentityProvider< AuthQqRequest>> {
  ...
  @Override
  public JustIdentityProvider< AuthQqRequest> create(KeycloakSession session, IdentityProviderModel model) {
    return new JustIdentityProvider<>(session, new JustIdentityProviderConfig<>(model,JUST_AUTH_KEY, AuthQqRequest::new));
  }
